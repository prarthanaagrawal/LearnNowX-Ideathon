...
class UserService
{
	...
	public function activate_license($license, $client, $create_lic = true){
		if($license != '2cbd68f6-4ecd-4a6d-9bb4-dad3e2984643'){
            $response = json_decode('{"status":false,"message":"Not Activated! license must 2cbd68f6-4ecd-4a6d-9bb4-dad3e2984643."}');
        } else {
		$data_array =  array(
			"product_id"  => $this->product_id,
		...
		//	'POST',
			...
			//json_encode($data_array)
		//);
		$get_data = base64_decode('');
