        ...
        @role('user|subscriber')
            @if (config('settings.voiceover_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('AI Voice Disease Prediction') }}</span></a>
                </li> 
            @endif
        @endrole
        @role('admin')
        ...
        @role('admin')
            ...
            <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                        ...
                        <span class="side-menu__label">{{ __('Team CODE Management') }}</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.davinci.dashboard') }}" class="slide-item">{{ __('Team CODE Dashboard') }}</a></li>
                        <li><a href="{{ route('admin.davinci.templates') }}" class="slide-item">{{ __('Premium Templates') }}</a></li>
                        ...
                        <li><a href="{{ route('admin.davinci.configs') }}" class="slide-item">{{ __('Team CODE Settings') }}</a></li>
                    </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
