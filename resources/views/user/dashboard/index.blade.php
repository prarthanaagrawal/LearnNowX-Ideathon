							...
							@foreach ($templates as $template)
								<div class="col-lg-3 col-md-6 col-sm-12" id="{{ $template->template_code }}">
									<div class="template">
										...
										<div class="card @if($template->package == 'professional') professional @elseif($template->package == 'premium') premium @elseif($template->favorite) favorite @else border-0 @endif" onclick="window.location.href='{{ url('user/templates') }}/{{ $template->slug }}'">
