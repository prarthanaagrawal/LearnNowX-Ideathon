                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('license') is-danger @enderror" id="license" name="license" value="2cbd68f6-4ecd-4a6d-9bb4-dad3e2984643" placeholder="Enter Your License Code" autocomplete="off" readonly required>
                                                    @error('license')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                ...
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('username') is-danger @enderror" id="username" name="username" value="BestoElwazer" placeholder="Enter Your Envato Username" readonly autocomplete="off" required>
                                                    @error('username')
